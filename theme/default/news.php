...
<table border="0" align="center">
  <tr>
    ...
    <td height="43" bgcolor="#eaeaea" style="color:#666;font-family:'microsoft yahei';font-size:14px;padding-left:13px;"><?php echo $row_news_catalog['name']; ?> &gt; <?php echo $row_news['title']; ?></td>
  </tr>
  <tr>
    ...
    <td width="770" height="800" valign="top" bgcolor="#FFFFFF"><table width="700" border="1" align="center" cellspacing="0" bordercolor="#eaeaea">
      <tr>
        <td width="700"><table width="700" border="0">
		  ...
		  <tr >
		   <td width="700" ><div class="news_title"><?php echo $row_news['title']; ?></div>
		     <div class="news_content"><?php echo $row_news['content']; ?></div></td>
		      </tr>
          </table>
          <p>&nbsp;</p></td>
      </tr>
