			...
			<table
				...
				<tr>
					<td><a style="text-decoration: none; color: #000000;"
						href="javascript://" name="comment_list"><div align="center">评价列表</div></a></td>
				</tr>
			</table></td>
		<td><br />
			<table style="border-bottom: 1px solid #DEDFDE" width="885"
				height="31" border="0">
				<tr>
					<td>&nbsp;</td>
				</tr>
...
<table width="990" border="1" style="border-bottom-width: 0;"
	align="center" cellpadding="0" cellspacing="0" bordercolor="#ddd">
	<tr>
		<td><table style="color: #666666;" width="100%" height="31" border="0"
...
<?php do { ?>
<div
	style="width: 988px; margin: auto 0; border: 1px solid #ddd; border-top-width: 0px;">
	<table width="100%"
		style="font-family: 宋体; font-size: 12px; margin: 0px auto; border-collapse: collapse;"
		border="0" id="comment_list" align="center" cellpadding="0"
		cellspacing="0" bordercolor="#ddd">
		<tr>
			<td height="159" style="padding-left: 20px;"><?php echo $row_comments['message']; ?></td>
			<td width="135" height="159" style="padding-left: 21px;"><p
					align="left"><?php echo $row_comments['username']; ?></p>
...
<form action="<?php echo $editFormAction; ?>" method="post"
	name="new_comment" id="new_comment">
	<table width="990" align="center" style="margin: 0px auto;">
		...
		<tr valign="middle">
			<td style="padding-top: 10px;"><label> <input
				...
				title="点击刷新" src="/kcaptcha/comment_captcha.php" align="absbottom"
				onclick="this.src='kcaptcha/comment_captcha.php?'+Math.random();"><input
