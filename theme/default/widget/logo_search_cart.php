    ...
    <td align="center">
 		<form  align="center" id="product_search_form" name="product_search_form" method="get" action="/search.php">
  	 	  <div align="center" style="margin:auto 0;">
  	 	    <input style="float:left;line-height:24px;<?php if(strpos($_SERVER['PHP_SELF'],"index.php")!=1){?>height:24px;<?php }else{ ?>height:24px;<?php } ?>padding:4px;border-style:solid;outline:0;width:446px;border-color:#B61D1D;" name="keywords" type="text" id="keywords" />
