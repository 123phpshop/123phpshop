...
<style type="text/css">
<!--
.catalog_floor_product_name {font-size: 12px}
.catalog_floor_product_price {
	font-size: 15px;
	color: #FF0000;
	font-weight: bold;
}
...
<table width="200" height="237" style="border:1px solid #EDEDED">
      ...
      <tr valign="top">
        <td height="36" valign="middle" style="padding-left:17px;"><span class="catalog_floor_product_name"><?php echo $row_season['name']; ?></span></td>
      </tr>
      <tr>
        <td  style="padding-left:17px; height="12"><div align="left"><span class="catalog_floor_product_price">￥<?php echo $row_season['price']; ?></span> </div></td>
      </tr>
    </table>
	</td>
    <?php } ?>
