...
$query_brand = sprintf("SELECT * FROM brands WHERE id = %s and is_delete=0", $colname_brand);
...
<title><?php echo $row_brand['name']; ?>-产品列表</title>
<style type="text/css">
<!--
.STYLE1 {color: #FF0000}
...
<table style="margin-top:10px;margin-bottom:10px;" width="1210" height="24" border="0" align="center" cellspacing="0">
  <tr>
    <td height="24"><strong  style="margin-left:10px;"><?php echo $row_brand['name']; ?></strong> &gt;产品列表</td>
  </tr>
</table>
<table style="border-top:1px solid #DDD;border-bottom:1px solid #DDD;" width="1210" height="35" align="center" cellpadding="0" cellspacing="0"  bgcolor="#F1F1F1">
  <tr>
    <td height="24"><strong  style="margin-left:10px;"><?php echo $row_brand['name']; ?></strong></td>
  </tr>
</table>
<br />
<table width="1210" border="0" align="center">
  ...
  <tr>
    <td valign="top"><?php include('widget/product/brand_product.php'); ?></td>
  </tr>
</table>
