...
function get_sales_link(){
	$result="";
	$sort="asc";
	if(!isset($_GET['catalog_id'])){return $result;}
	$base_url="/product_list.php?catalog_id=".$_GET['catalog_id']."&sort_by=sales&sort=";
...
function get_price_link(){
	...
	$sort="asc";
	if(!isset($_GET['catalog_id'])){return $result;}
	$base_url="/product_list.php?catalog_id=".$_GET['catalog_id']."&sort_by=price&sort=";
	if(isset($_GET['sort']) && $_GET['sort']=="asc"){
		return $base_url.="desc";
	}
	return $base_url.=$sort;
...
function get_comments_link(){
	...
	$sort="asc";
	if(!isset($_GET['catalog_id'])){return $result;}
	$base_url="/product_list.php?catalog_id=".$_GET['catalog_id']."&sort_by=comments&sort=";
	if(isset($_GET['sort']) && $_GET['sort']=="asc"){
		return $base_url.="desc";
	}
	return $base_url.=$sort;
...
function get_sheft_link(){
	...
	$sort="asc";
	if(!isset($_GET['catalog_id'])){return $result;}
	$base_url="/product_list.php?catalog_id=".$_GET['catalog_id']."&sort_by=sheft&sort=";
	if(isset($_GET['sort']) && $_GET['sort']=="asc"){
		return $base_url.="desc";
	}
	return $base_url.=$sort;
...
<table style="margin-top:2px;margin-left:3px;border-collapse:collapse;" width="216" height="25" border="1" cellspacing="0" bordercolor="#CCCccc" bgcolor="#FFFfff">
          <tr align="center">
