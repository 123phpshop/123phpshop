...
$ad_products = mysql_query($query_ad_products, $localhost) ;
...
<table width="208" border="1" cellpadding="0" cellspacing="0" bordercolor="#dddddd">
  ...
  <tr>
	...
	$product_images = mysql_query($query_product_images, $localhost) ;if(!$Result1){$logger->fatal("数据库操作失败:".$updateSQL);}
