...
if (!_check_dir_writable($config_folder)) { // 检查配置文件是否可写，如果不可写，那么告知
    $error[] = "错误:" . $config_folder . "文件夹不可写，无法完成安装，请联系系统管理员修改这个文件夹的读写属性,或是呼叫13391334121联系我们的支持人员";
}

if (!_check_file_writable($config_file)) { // 检查配置文件是否可写，如果不可写，那么告知
...
<form id="install_form" name="install" method="post" action="">
		...
		<span style="float: right; display: inline;"><?php $doc_url = "install.html";
$support_email_question = "安装程序";include $_SERVER['DOCUMENT_ROOT'] . "/admin/widgets/dh.php";?></span>
