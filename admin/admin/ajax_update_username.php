...
if (isset($_POST['username'])) {
  $colname_member = (get_magic_quotes_gpc()) ? $_POST['username'] : addslashes($_POST['username']);
}
$colname_id = "-1";
if (isset($_POST['id'])) {
...
$query_member = sprintf("SELECT * FROM member WHERE username = '%s' and id!='%s'", $colname_member, $colname_id);
