...
<?php
$doc_url="logistics.html#activate";
$support_email_question="激活快递公司";
...
if($could_delete==1){
	...
	$update_catalog = sprintf("update `express_company` set disabled='false' where id = %s", $colname_product);
