...
?>
    ...
    <tr valign="baseline">
      ...
      <td valign="baseline"><input type="radio" name="is_virtual" value="1" <?php if (( $is_vproduct_add_page==true && !isset($row_product['is_virtual'])) || !(strcmp($row_product['is_virtual'],"1")) || $is_vproduct_add_page==true) {echo "CHECKED";} ?> />
是
