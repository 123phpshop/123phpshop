...
<table width="960" border="1" class="phpshop123_list_box">
  ...
  <tr>
       <td width="54"> 
       <input type="radio" onclick="set_consignee(this)" consignee_name="<?php echo $row_goods['name']; ?>" consignee_province="<?php echo $row_goods['province']; ?>" consignee_city="<?php echo $row_goods['city']; ?>" consignee_district="<?php echo $row_goods['district']; ?>"   consignee_address="<?php echo $row_goods['address']; ?>" consignee_zip="<?php echo $row_goods['zip']; ?>" consignee_mobile="<?php echo $row_goods['mobile']; ?>" <?php if($row_goods_num==1 || $row_goods['name']==$row_order['consignee_name'] ){ ?>checked<?php }  ?> name="consingee_id" value="<?php echo $row_goods['id']; ?>">
       </td>
