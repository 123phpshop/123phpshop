...
<body>
<p class="phpshop123_title">中通:添加配送区域</p><?php include($_SERVER['DOCUMENT_ROOT']."/admin/widgets/dh.php");?>
<p>&nbsp; </p>
...
* </td>
     ...
     <tr valign="baseline">
      ...
      <td valign="baseline"><input name="shipping_by_quantity" type="radio" value="按重量" checked="checked" onchange="by_weight()" />
按重量
