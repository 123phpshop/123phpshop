...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE shipping_method_area SET area=%s, shipping_by_quantity=%s, first_kg_fee=%s, continue_kg_fee=%s, free_quota=%s, name=%s, single_product_fee=%s WHERE id=%s",
...
<body>
<p class="phpshop123_title">顺丰：更新送区域</p>
<p>&nbsp; </p>
