...
$support_email_question="更新圆通配送区域";log_admin($support_email_question);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE shipping_method_area SET area=%s, shipping_by_quantity=%s, name=%s, single_product_fee=%s, first_kg_fee=%s, continue_kg_fee=%s WHERE id=%s",
