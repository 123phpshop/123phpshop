...
$support_email_question="激活支付方式";log_admin($support_email_question);
$could_delete=1;
$colname_product = "-1";
if (isset($_GET['id'])) {
...
if($could_delete==1){
	...
	$update_catalog = sprintf("update `pay_method` set is_activated=1 where id = %s", $colname_product);
