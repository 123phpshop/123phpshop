...
<body>
	<span class="phpshop123_title">添加广告</span>
	<div id="doc_help"
...
<form method="post" name="form1" id="form1"
		...
		<table align="center" class="phpshop123_form_box">
			<tr valign="baseline">
				...
				<td><input name="name" type="text" id="name" value="" size="32"
					maxlength="32"> *</td>
			</tr>
			<tr valign="baseline">
				<td nowrap="nowrap" align="right">长度:</td>
				<td><label> <input name="image_width" type="text" id="image_width"
						maxlength="5" /> *[像素]
				</label></td>
			</tr>
			<tr valign="baseline">
			...
			<tr valign="baseline">
				...
				<td><textarea name="intro" cols="50" rows="5" id="intro"></textarea>
				</td>
			</tr>
			<tr valign="baseline">
