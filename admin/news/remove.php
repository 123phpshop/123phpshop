...
if($could_delete==1){
	...
	if(!$update_catalog_query){
		...
		$remove_succeed_url="index.php?catalog_id=".$row_news['catalog_id'];
...
<div class="phpshop123_infobox">
  ...
  <p>由于以下原因，您不能删除这个分类，请及时修正，或是联系123phpshop.com的技术支持人员！<?php include($_SERVER['DOCUMENT_ROOT']."/admin/widgets/dh.php");?></p>
  <p>1. 	新闻不存在，请检查参数之后再试。</p>
