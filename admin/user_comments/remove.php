...
<?php
$doc_url="comment.html#delete";
$support_email_question="删除用户评论";log_admin($support_email_question);
$could_delete=1;
...
$query_news = sprintf("SELECT * FROM product_comment WHERE id = %s", $colname_news);
...
if($could_delete==1){
	...
	$update_catalog = sprintf("update `product_comment` set is_delete=1 where id = %s ", $colname_news);
...
<div class="phpshop123_infobox">
  ...
  <p>由于以下原因，您不能删除这条记录，请及时修正，或是联系123phpshop.com的技术支持人员！<div id="doc_help" style="display:inline;height:40px;line-height:50px;color:#CCCCCC;"><a style="color:#CCCCCC;margin-left:3px;" target="_blank" href="<?php echo isset($doc_url)?"http://www.123phpshop.com/doc/v1.5/".$doc_url:"http://www.123phpshop.com/doc/";?>">[文档]</a><a style="color:#CCCCCC;margin-left:3px;" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1718101117&site=qq&menu=yes">[人工支持]</a><a href=mailto:service@123phpshop.com?subject=我在<?php echo $support_email_question;?>的时候遇到了问题，请支持 style="color:#CCCCCC;margin-left:3px;">[邮件支持]</a></div></p>
