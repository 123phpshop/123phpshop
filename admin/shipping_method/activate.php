...
$support_email_question="激活送货方式";log_admin($support_email_question);
$colname_admin = "-1";
$could_delete=1;
...
if($could_delete==1){
	...
	$update_catalog = sprintf("update `shipping_method` set is_activated=1 where id = %s", $colname_admin);
