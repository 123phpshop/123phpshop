...
<?php
$doc_url="shopinfo.html";
$support_email_question="更新店铺信息";
...
$info = mysql_query($query_info, $localhost) ;if(!$Result1){$logger->fatal("数据库操作失败:".$updateSQL);}
...
<body>
<span class="phpshop123_title">店铺信息</span><?php include($_SERVER['DOCUMENT_ROOT']."/admin/widgets/dh.php");?>
