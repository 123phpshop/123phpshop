...
<body>
<span class="phpshop123_title" style="display:inline;">添加虚拟商品 </span>
<?php include($_SERVER['DOCUMENT_ROOT']."/admin/widgets/dh.php");?><a href="vindex.php"><input style="float:right;" type="submit" name="Submit2" value="虚拟商品列表" /></a>
