...
<span class="phpshop123_title" style="display:inline;">添加虚拟商品 </span><div style="float:right;display:inline;"><input name="submit" type="submit" value="+" style="width:30px;height:30px;margin:auto auto;"/></div>
