...
if($could_delete==1){
	...
	$update_catalog = sprintf("update `product` set is_delete=0 where id = %s", $colname_product);
...
<div class="phpshop123_infobox"><span>由于以下原因，您不能恢复这个商品：</span>
...
<p>1.	商品不存在，请检查参数之后再试。</p>
<p>2. 	系统错误，无法删除，请示稍后再试。 </p>
<p>您也可以<a href="index.php">点击这里返回</a>。</p></div>
  <?php } ?>
