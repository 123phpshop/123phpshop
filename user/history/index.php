...
$comments = mysqli_query($localhost,$query_limit_comments);if(!$Result1){$logger->fatal("数据库操作失败:".$updateSQL,$query_limit_comments);}
...
<body>
<p class="phpshop123_user_title">浏览历史</p>
  ...
  <table width="100%" border="0" align="center" class="phpshop123_user_list_box">
    <tr>
      <td width="62%">商品</td>
      <td width="17%"><div align="right">浏览时间</div></td>
    </tr>
    <?php do { ?>
      <tr>
